...
public class MapLab {
    ...
    public static void main(String[] args) {
        ...
        // SECTION 3: Counting Frequencies
        ...
        Integer javaCount = wordFrequency.get(searchWord);
        Integer unknownCount = wordFrequency.get("unknown");
        Integer programmingCount =
                wordFrequency.getOrDefault("programming", 0);

        System.out.println("   Frequency of '" + searchWord + "': " + javaCount);
        System.out.println("   Frequency of 'unknown': " + unknownCount);
        System.out.println("   Frequency of 'programming': " + programmingCount);
        System.out.println();


        // SECTION 5: Checking Keys and Values
        System.out.println("5. Checking if map contains keys and values...");
        ...
        // SECTION 6: Updating Values
        System.out.println("6. Manually updating a word frequency...");

        System.out.println(
                "   Before update - 'applications' frequency: "
                + wordFrequency.get("applications")
        );

        wordFrequency.put("fun", 10);

        System.out.println(
                "   After update - 'applications' frequency: "
                + wordFrequency.get("applications")
        );
        ...
        // SECTION 8: Most and Least Frequent
        ...
        System.out.println("   All unique words: "
                + wordFrequency.keySet());

        System.out.println("   All frequency values: "
